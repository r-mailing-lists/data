...
```
    ...
    Classes 'tbl' and 'data.frame': 63707 obs. of  5 variables:
...
```
    ...
    * <chr>            <int>      <int> <chr> <chr>       <chr>         <chr>       
    ...
    2 Duncan …         12594         13 r-he… r-help:733… 2000-02-16T2… 2026-09-16T…
