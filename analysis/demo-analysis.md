...
```
    ...
    Classes 'tbl' and 'data.frame': 63659 obs. of  5 variables:
...
```
    ...
    * <chr>            <int>      <int> <chr> <chr>       <chr>         <chr>       
    ...
    2 Duncan …         12588         13 r-he… r-help:733… 2000-02-16T2… 2026-07-29T…
